...
.resizable-textarea .grip {
    background:#EEEEEE url(/static/images/textarea-grip.png) no-repeat scroll center 2px;
    border-color:#DDDDDD;
    border-style:solid;
...
#view_form .translatable {
    background: url("/static/images/stock/stock_translate.png") no-repeat right center;
}
