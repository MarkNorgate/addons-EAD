    ...
    <tr>
    	<td>
            <table id="header_" class="header" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td rowspan="2">
                        <a href="http://www.cornwallmobilitycentre.co.uk/" alt="Cornwall Mobility Centre" style="float: left">
                        ${cp.root.get_logo()|n}
                        </a>               
                        <br/><a style="padding:0px;margin:10px 150px" title="Cornwall Mobility Centre" target="_blank" href="/">
                                        <img border="0" src="/static/images/company_logo.jpg" width="250px"></a>
                    </td>
                ...
                <tr>
                    ...
                    <td align="right" colspan="2" valign="middle" style="padding-right:10px;padding-bottom:10px">
