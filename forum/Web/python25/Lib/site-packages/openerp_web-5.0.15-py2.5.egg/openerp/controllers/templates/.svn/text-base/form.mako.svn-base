                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <button
                                                ...
                                                style="display:none" onclick="submit_form('save_and_edit')">${_("Save & Edit")}</button>
                                            % endif
                                            % if buttons.edit:
                                            <button 
                                                type="button" 
                                                title="${_('Duplicate this resource')}"
                                                style="display:none" onclick="submit_form('duplicate')">${_("Duplicate")}</button>
                                            % endif
                                            % if buttons.delete:
                                            <button 
                                                type="button"
...
-->
                                            <button 
                                                type="button" 
                                                title="${_('Cancel editing the current resource')}" 
                                                onclick="location.href='/menu';">${_("Cancel")}</button>
                                            % endif
                                        </td>
                                        % if buttons.pager:
