...
<%def name="content()">
    <div class="view">
        ...
        <center>
            <!-- ${ cp . root . developped_by () | n } //Please remove spaces in between {}--> 
        </center>
        ...
        <form action="${target}" method="post" name="loginform">
            ...
            <div class="box2 welcome">${_("Welcome to Cornwall Mobility Centre")}</div>
                ...
                <table align="center" cellspacing="2px" border="0">
                    <tr style="display:none">
                        ...
                        <td>
                            ...
                            % else:
                                <input type="text" name="db" style="width: 300px;" value="cmc"/>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <button type="button" style="white-space: nowrap;display:none" tabindex="-1" onclick="location.href='/database'">${_("Databases")}</button>
                            % endif
