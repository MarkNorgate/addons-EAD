            ...
            <table id="${name}_grid" class="grid" width="100%" cellspacing="0" cellpadding="0">
                ...
                <thead>
                    <tr class="grid-header">
                        ...
                        % endif
                        % if editable:
                        <th class="grid-cell selector" style="width:4%"><div style="width: 0px;"></div></th>
                        % endif
                ...
                <tbody>
                    ...
                    <tr class="grid-row editors">
                        ...
                        % endfor
                        <td class="grid-cell selector" style="text-align: center; padding: 0px;">
                            <img src="/static/images/listgrid/delete_inline.gif" class="listImage editors" border="0" title="${_('Cancel')}" onclick="new ListView('${name}').reload()" style="display:none"/>
                        </td>
                    </tr>
                    % endif
                    </%def>
                    ...
                    <tr class="grid-row" record="${data['id']}">
                        ...
                        % endif
                        % if editable:
                        <td class="grid-cell selector" style="cursor:pointer" nowrap="nowrap">
                            % if not editors:
                            <a title="${_('Edit')}" onclick="editRecord(${data['id']}, '${source}')" href="javascript:void(0)"> <img src="/static/images/listgrid/edit_inline.gif" class="listImage" border="0"/> Edit</a>
                            % else:
                            <a title="${_('Edit')}" onclick="new ListView('${name}').edit(${data['id']})" href="javascript:void(0)"> <img src="/static/images/listgrid/edit_inline.gif" class="listImage" border="0" title="${_('Edit')}"/>Edit</a>
                            % endif
                        </td>
                        % endif
                        % for i, (field, field_attrs) in enumerate(headers):
                        ...
                        % if editable:
                        <td class="grid-cell selector">
                            <img src="/static/images/listgrid/delete_inline.gif" class="listImage" border="0" title="${_('Delete')}" onclick="new ListView('${name}').remove(${data['id']})" style="display:none"/>
                        </td>
                        % endif
                    </tr>
                    </%def>
