            ...
            try:
                ...
                if isinstance(domain, (str, unicode)):
                    try:
                        ...
                        domain = []
                #Surya - this is the state combo box then pass the id of the current assessment record
                if attrs.get('relation') == 'cmc.assessment.state' or attrs.get('relation') == 'cmc.assessment.outcome' or attrs.get('relation') == 'cmc.assessment.report':
                    ids = proxy.search('id='+str(attrs.get('id')))
                else:
