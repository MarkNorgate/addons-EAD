...
class wizard_workshop_service_repair_quote(wizard.interface):
...
#===============================================================================
        ...
        pooler.get_pool(cr.dbname).get('cmc.workshop.task.history').create(cr, uid, {
                                                                        ...
                                                                        'description':'Quote Estimate Printed',
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.service.repair.quote', 'state':'end'}
            }
            
        
    }

wizard_workshop_service_repair_quote('wizard_workshop_service_repair_quote')
