...
class wizard_workshop_pdi_power(wizard.interface):
...
#===============================================================================
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.pdi.power', 'state':'end'}
            }
            
        
    }

wizard_workshop_pdi_power('wizard_workshop_pdi_power')
