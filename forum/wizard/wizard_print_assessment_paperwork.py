...
class wizard_print_assessment_paperwork(wizard.interface):
    ...
    def _details(self, cr, uid, data, context):
        ...
        if prev_record.driving_assessment_type:
            ...
            if prev_record.driving_assessment_type in ['hoist_demo','bathing_assessment','other_ilme_equipment_assessment','wheel_walker']:
                report_rml="eMobility/Paperwork Template/"+prev_record.driving_assessment_type+".ods"
                report_type='oo-xls'
            else:
                report_rml="eMobility/Paperwork Template/"+prev_record.driving_assessment_type+".odt"
                report_type='oo-doc'
            debug(report_rml)
            ...
            data['form']['assessment_date']=prev_record.assessment_date if prev_record.assessment_date else "" 
            ...
            data['form']['town']=person_id.city if person_id.city else ""
            data['form']['county']=person_id.county if person_id.county else ""
    ...
    states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'print.assessment.paperwork', 'target':'new', 'state':'end'}
            }
    }
wizard_print_assessment_paperwork('print.assessment.paperwork.wizard')
