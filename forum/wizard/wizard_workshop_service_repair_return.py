...
class wizard_workshop_service_repair_return(wizard.interface):
...
#===============================================================================
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.service.repair.return', 'state':'end'}
            }
            
        
    }

wizard_workshop_service_repair_return('wizard_workshop_service_repair_return')
