...
class wizard_workshop_service_repair_order(wizard.interface):
...
#===============================================================================
        ...
        pooler.get_pool(cr.dbname).get('cmc.workshop.task.history').create(cr, uid, {
                                                                        ...
                                                                        'title':'Order Form',
                                                                        'description':'Order Form Printed',
        ...
        data['form']['supplier']=""
        if 'part_ordered' in data['form']:
            supplier_id=data['form']['part_ordered'][0][2]
            debug(supplier_id)
            supplier_record = pooler.get_pool(cr.dbname).get('cmc.person').browse(cr, uid, supplier_id[0])
            data['form']['supplier']=supplier_record.display_name
        #=======================================================================
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.service.repair.order', 'state':'end'}
            }
            
        
    }

wizard_workshop_service_repair_order('wizard_workshop_service_repair_order')
