...
class wizard_workshop_service_collection_delivery(wizard.interface):
...
#===============================================================================
        ...
        pooler.get_pool(cr.dbname).get('cmc.workshop.task.history').create(cr, uid, {
                                                                        ...
                                                                        'title':'Collection Delivery Form',
                                                                        'description':'Collection Delivery Form Printed',
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.service.collection.delivery', 'state':'end'}
            }
            
        
    }

wizard_workshop_service_collection_delivery('wizard_workshop_service_collection_delivery')
