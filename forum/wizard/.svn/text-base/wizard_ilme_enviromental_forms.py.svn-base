...
report=False
class wizard_ilme_enviromental_forms(wizard.interface):
    ...
    states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'ilme.enviromental.form', 'target':'new', 'state':'end'}
            }
    }
wizard_ilme_enviromental_forms('wizard_ilme_enviromental_forms')
