...
class wizard_workshop_service_repair_loan(wizard.interface):
...
#===============================================================================
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.service.repair.loan', 'state':'end'}
            }
            
        
    }

wizard_workshop_service_repair_loan('wizard_workshop_service_repair_loan')
