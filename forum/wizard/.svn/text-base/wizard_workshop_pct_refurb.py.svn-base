...
class wizard_workshop_pct_refurb(wizard.interface):
...
#===============================================================================
        ...
        pooler.get_pool(cr.dbname).get('cmc.workshop.task.history').create(cr, uid, {
                                                                        ...
                                                                        'title':'PCT refurb Form',
                                                                        'description':'PCT Refurb Form Printed',
        ...
        data['form']['order_no']=prev_record.equipment_id.order_no
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.pct.refurb', 'state':'end'}
            }
            
        
    }

wizard_workshop_pct_refurb('wizard_workshop_pct_refurb')
