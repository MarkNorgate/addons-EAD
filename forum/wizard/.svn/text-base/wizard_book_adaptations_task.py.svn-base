...
class wizard_book_adaptations_task(wizard.interface):
    ...
    _action_fields = {
        ...
        'job_type': {'type':'selection',
                          'selection':[('Adaptations', 'Adaptations')],
...
wizard_book_adaptations_task('wizard_book_adaptations_task')
