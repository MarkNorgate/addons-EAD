...
class wizard_workshop_enquiry_form(wizard.interface):
...
#===============================================================================
        ...
        pooler.get_pool(cr.dbname).get('cmc.workshop.task.history').create(cr, uid, {
                                                                        ...
                                                                        'title':'Enquiry Form',
                                                                        'description':'Adaptation Enquiry Form Printed',
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.enquiry.form', 'state':'end'}
            }
            
        
    }

wizard_workshop_enquiry_form('wizard_workshop_enquiry_form')
