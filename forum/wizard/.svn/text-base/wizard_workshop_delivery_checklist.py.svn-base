...
class wizard_workshop_delivery_checklist(wizard.interface):
...
#===============================================================================
        ...
        pooler.get_pool(cr.dbname).get('cmc.workshop.task.history').create(cr, uid, {
                                                                        ...
                                                                        'title':'Adaptations Delivery Checklist',
                                                                        'description':'Adaptations Delivery Checklist Printed',
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.delivery.checklist', 'state':'end'}
            }
            
        
    }

wizard_workshop_delivery_checklist('wizard_workshop_delivery_checklist')
