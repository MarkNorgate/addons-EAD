...
class wizard_workshop_chaseup_letter_client(wizard.interface):
...
#===============================================================================
        ...
        if prev_record.current_user_id.display_name:
            ...
            raise('Warning','Following Workshop Task has no Current User')
        #=======================================================================
   ...
   states = {
        'init': {
            'actions': [_details],
            'result': {'type':'print', 'report':'workshop.chaseup.letter.client', 'state':'end'}
            }
            
        
    }

wizard_workshop_chaseup_letter_client('wizard_workshop_chaseup_letter_client')
